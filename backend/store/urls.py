...
urlpatterns = [
    ...
    path("admin/attribution/", AdminAttributionView.as_view(), name="admin-attribution"),
    ...
    path("admin/hero-banner-slides/", AdminHeroBannerSlideListCreateView.as_view(), name="admin-hero-banner-slides"),
    path("admin/hero-banner-slides/<int:pk>/", AdminHeroBannerSlideDetailView.as_view(), name="admin-hero-banner-slide-detail"),
